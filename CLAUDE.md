...
**To consume a kit:** copy `prompts/<project-type>/` contents into the target repo root, then copy any referenced generic commands from `prompts/common/commands/` into `.claude/commands/`.
