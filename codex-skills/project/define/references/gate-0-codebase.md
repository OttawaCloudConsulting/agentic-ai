...
Spawn a sub-agent using Codex sub-agent delegation to perform a deep codebase scan. The agent reads 20-40 files and writes structured findings to a temporary scratch file.
...
2. **Use a concise user question** with options:
