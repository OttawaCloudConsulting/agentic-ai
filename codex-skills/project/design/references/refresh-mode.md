...
1. Use file globbing to find all files matching `milestones/*/plans/*.md`.
...
After presenting all deviations, use a concise user question with a multiSelect to let the user pick which deviations to consolidate into the architecture doc:
...
Use the Codex editing tools for all updates to preserve the rest of the document.
...
2. Use a concise user question with options: **Approve** / **Revise** / **Partial**
