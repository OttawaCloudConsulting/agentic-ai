...
- Creating skills or commands — use `/occ-skill-creator`
- Creating Kiro steering files — different format conventions

## Related Skills

- **occ-skill-creator** — for creating skills (action workflows with supporting assets), not rules (always-on guidelines)
