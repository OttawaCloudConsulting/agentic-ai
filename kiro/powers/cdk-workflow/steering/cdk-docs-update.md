# CDK Documentation Update Workflow

Synchronize README.md, docs/ARCHITECTURE.md, and docs/TESTING.md with the current state of the CDK codebase. These files contain counts, tables, and summaries that drift as features are added.
...
- **Accuracy over speed** — verify counts by running tests and reading source files, do not guess
