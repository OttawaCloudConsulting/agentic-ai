...
1. **Stop** — no retry, no next action
...
3. **Log** — record the correction: "Assumed X, observed Y. Model of Z was wrong."
...
Losing the thread? Stop. Record state before continuing.
...
1. Create an investigation record for the topic
2. Separate **FACTS** (verified) from **THEORIES** (plausible)
3. Maintain **3+ competing hypotheses** — never chase just one
4. Record: what tested, why, what found, what it means

When resolved, record outcome summary.
