# Terraform Documentation Update Workflow

Synchronize README.md and docs/ARCHITECTURE.md with the current state of the Terraform codebase. These files contain tables, diagrams, and summaries that drift as features are added.
