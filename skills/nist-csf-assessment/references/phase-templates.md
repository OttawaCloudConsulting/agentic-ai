...
|---|---|---|---|
| [e.g., CloudTrail] | Audit logging | configs/*.yaml | DE (Detect), ID (Identify) |
| [e.g., GuardDuty] | Threat detection | terraform/*.tf | DE (Detect) |
...
- **AWS Evidence:** [AWS services contributing to this outcome, e.g., AWS Organizations for organizational structure]
- **Customer Evidence:**
...
- **Status:** [Implemented / Partially Implemented / Not Implemented / Not Applicable]
- **AWS Evidence:** [e.g., AWS Config — resource inventory and configuration history]
- **Customer Evidence:**
  - [file:line — description]
...
- **Status:** [Implemented / Partially Implemented / Not Implemented / Not Applicable]
- **AWS Evidence:** [e.g., IAM Identity Center, AWS IAM — identity lifecycle management]
- **Customer Evidence:**
  - [file:line — description]
...
- **Status:** [Implemented / Partially Implemented / Not Implemented / Not Applicable]
- **AWS Evidence:** [e.g., VPC Flow Logs, CloudWatch, Security Hub — network monitoring]
- **Customer Evidence:**
  - [file:line — description]
...
- **Status:** [Implemented / Partially Implemented / Not Implemented / Not Applicable]
- **AWS Evidence:** [e.g., AWS Systems Manager OpsCenter, AWS Support — incident coordination]
- **Customer Evidence:**
  - [file:line — description]
...
- **Status:** [Implemented / Partially Implemented / Not Implemented / Not Applicable]
- **AWS Evidence:** [e.g., AWS Backup, CloudFormation StackSets — infrastructure recovery]
- **Customer Evidence:**
  - [file:line — description]
...
**AWS Remediation:**
[Specific AWS services or features that address this gap]

**Remediation Recommendation:**
[Specific, actionable guidance — reference AWS services, IaC constructs, or configuration changes]
...
## Function-Level AWS Shared Responsibility Summary
...
| ID — Identify | Medium — asset inventory via Config/SSM; threat intel via Security Hub | Classification, risk assessment, improvement processes |
| PR — Protect | High — encryption, network controls, IAM via AWS services | Configuration, access management, awareness training |
| DE — Detect | High — CloudTrail, GuardDuty, VPC Flow Logs, Security Hub | Alerting thresholds, SIEM integration, event analysis |
| RS — Respond | Low — response is primarily customer | IR plan, runbooks, communication, incident management |
| RC — Recover | Medium — backup/restore via AWS Backup; IaC redeployment | RTO/RPO definition, DR testing, recovery communication |
