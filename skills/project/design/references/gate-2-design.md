...
Spawn a sub-agent using the `Agent` tool to perform a deep architecture-focused codebase scan. The agent reads 15-30 files and writes structured findings to a temporary scratch file.
